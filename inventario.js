...
{ id: "Adaga", content: "Adaga", uuid: "extra-adaga", slot: "weapon", description: "Uma punhal afiado.", damage: "1D4", image: "https://raw.githubusercontent.com/DanielSanMedium/CentelhaGame/main/images/Adaga.png" },
...
newItem.dataset.itemName = item.content;
...
if (slot.dataset.slot === "weapon" && equippedItemName) {

// Busca o objeto da arma no catálogo

const weaponObj = allItemsArr.find(i => i.content === equippedItemName && i.ammoType);
...
slot.innerHTML = `<img src="${weaponObj.image}" alt="${weaponObj.content}" /> (${loadedAmmo}/${weaponObj.ammoCapacity})`;

slot.dataset.itemName = weaponObj.content;
...
slot.innerHTML = `<img src="${item.image}" alt="${item.content}" />`;
